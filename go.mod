...
require (
	...
	github.com/smartcontractkit/chainlink-common v0.10.1-0.20260306160904-e9cddd0d2288
	github.com/smartcontractkit/crec-api-go v0.5.2
...
require (
	...
	github.com/containerd/log v0.1.0 // indirect; indirec
