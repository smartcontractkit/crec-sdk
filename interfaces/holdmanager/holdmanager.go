...
// HoldmanagerABI is the input ABI used to generate the binding from.
// Deprecated: Use HoldmanagerMetaData.ABI instead.
var HoldmanagerABI = HoldmanagerMetaData.ABI
