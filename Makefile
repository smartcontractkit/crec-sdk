...
generate:
	...
	go-jsonschema services/ace/ccid/schema/identity_registry.json -p events -o services/ace/ccid/gen/events/events.go -t
	...
	abigen --abi services/ace/ccid/abi/IdentityRegistry.abi.json --pkg identityregistry --out services/ace/ccid/gen/identityregistry/identityregistry.go
